...
echo "Next: copy .env (see .env.example), install Ollama, optional: npm install && npm run build (from project root, Vite)"
echo "Run server:  source .venv/bin/activate && uvicorn server:app --host 0.0.0.0 --port 8000"
